  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[14%] left-[10%] w-[420px] h-[420px] rounded-full bg-white/10 blur-[110px]" />
        <div className="absolute bottom-[10%] right-[8%] w-[420px] h-[420px] rounded-full bg-[#9a9aa2]/10 blur-[120px]" />
      </div>
      ...
      >
        ...
        >
          <motion.h1
            ...
            className="font-bold leading-[1.1] tracking-tight text-[clamp(2.2rem,6vw,4rem)] max-w-6xl silver-text"
          >
            AirPods
          </motion.h1>
          ...
          >
            Áudio espacial imersivo, cancelamento ativo de ruído e um encaixe
            confortável para acompanhar você em qualquer lugar.
          </motion.p>
